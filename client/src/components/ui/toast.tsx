  ...
  "group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-md border p-6 pr-8 shadow-lg transition-all",
  {
    variants: {
      variant: {
        ...
        shortcut: "border bg-background text-foreground data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-80 data-[state=closed]:slide-out-to-bottom-center data-[state=open]:slide-in-from-bottom-center transform-gpu transition-all duration-300 !data-[state=open]:slide-in-from-bottom-center !data-[state=closed]:slide-out-to-bottom-center"
      },
    },
    defaultVariants: {
      variant: "default",
